...
cap program drop imean2;  
program define imean2, rclass ;    
version 9.2;         
...
capture program drop imean;
program define imean, eclass;
version 9.2;
...
imean2 ``k'' , hweight(`hweight')  hsize(`_ths')    conf(`conf') level(`level');
...
imean2 `1' ,  hweight(`hweight')  hsize(`_ths')   conf(`conf') 
...
imean2 `1' ,   hweight(`hweight') hsize(`_ths')   conf(`conf') level(`level');
