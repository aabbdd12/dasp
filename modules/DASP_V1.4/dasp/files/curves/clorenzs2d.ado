...
svmat float _res_b;
matrix drop _res_b;
rename _res_a1 _perc;
qui gen _dif = _res_a2-_res_b2;
...
qui keep in 1/101;
                   ...
                   local mylist = "_perc _dif _std _lb _ub";
if("`conf'"=="lb") local mylist = "_perc _dif _std _lb";
if("`conf'"=="ub") local mylist = "_perc _dif _std _ub"; 
...
local drhline = "";
if (`dhol'==1) local drhline ="(line   _nl _perc,  clcolor(gs9) lpattern(solid) `hor_line_opts')";
quietly {;
if (`dgra'!=0) {;
