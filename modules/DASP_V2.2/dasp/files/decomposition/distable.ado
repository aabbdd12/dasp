...
version 9.2;
syntax namelist(min=1 max=1) [, MATRIX(string) DEC(int 3) FCLEN(int 16) CLEN(int 16) ATIT(string) HEAD1(string) HEAD2(string) dsmidl(int 0) ];
tempname table;
tokenize `namelist';	
local ncol = colsof(`1');
local nrow = rowsof(`1');
