...
gen poor_union = (w_1<7) | (w_2<7) | (w_3<7)
mean  poor_union 
imdp_uhi w_1 w_2 w_3, pl1(7) pl2(7) pl3(7)
// Q2
gen poor_inter = (w_1<7) & (w_2<7) & (w_3<7)
mean  poor_inter
...
gen poor_union_targ1 = (w_1+2<7) | (w_2<7)   | (w_3<7)
gen poor_union_targ2 = (w_1<7)   | (w_2+2<7) | (w_3<7)
gen poor_union_targ3 = (w_1<7)   | (w_2<7)   | (w_3+2<7)

gen poor_inter_targ1 = (w_1+2<7) & (w_2<7)   & (w_3<7)
gen poor_inter_targ2 = (w_1<7)   & (w_2+2<7) & (w_3<7)
gen poor_inter_targ3 = (w_1<7)   & (w_2<7)   & (w_3+2<7)

mean  poor_union* 
mean  poor_inter* 

/* With the union approach, we focus in less deprived individuals  (the case of individual number 6, the is only deprived in dimension 3) */
/* With the intersection approach, we focus in  we focus in most deprived individuals (the case of individual number 3, and we target the dimension 2) */
...
cap drop ngap*
gen ngap1 = (7-w_1)/7*(7>w_1)
gen ngap2 = (7-w_2)/7*(7>w_2)
gen ngap3 = (7-w_3)/7*(7>w_3)
...
// Q2
imdp_bci w_1 w_2 w_3, alpha(1) gamma(1) b1(0.3333333) pl1(7) b2(0.3333333) pl2(7) b3(0.3333333) pl3(7)

// Q3
 gen nw_1 = (w_1+ w_2+w_3)/3
 gen nw_2 = (w_1+ w_2+w_3)/3
 gen nw_3 = (w_1+ w_2+w_3)/3
 imdp_bci nw_1 nw_2 nw_3, alpha(1) gamma(1) b1(0.3333333) pl1(7) b2(0.3333333) pl2(7) b3(0.3333333) pl3(7)
 /*
...
cap drop tngap*
gen tngap1 = (7-(w_1+2))/7*(7>(w_1+2))
gen tngap2 = (7-(w_2+2))/7*(7>(w_2+2))
gen tngap3 = (7-(w_3+2))/7*(7>(w_3+2))
...
// Q1
use "C:\Users\abara\Desktop\exercises_10&11_\Canada_Incomes&Taxes_1996_2005_random_sample_2.dta", replace
