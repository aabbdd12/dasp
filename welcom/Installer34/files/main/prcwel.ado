...
#delimit ;
capture program drop prcwel;
program define prcwel, rclass sortpreserve;
version 9.2;
...
if ("`lan'" == "") local lan = "en";
if ("`tjobs'" == ""  & "`tjobs'"~="off")  local tjobs 11 12 21 22 23 31 32 33  41 42 43 44 51 52 53 61 62 63 64;
...
tokenize `varlist';
if (`gvimp' == 1)    prjob41 `vlist',   hs(`hsize') hgroup(`hgroup') lan(en)  xrnames(`slist')  aggr(`taggregate') pcexp(`1')   wappr(`meas') model(`model') subs(`subs')  gvimp(`gvimp')  ;
...
if (`tjob`i'' == 41 ) {;
*set trace on;
prjob`tjob`i'' `vlist',   hs(`hsize') hgroup(`hgroup') lan(en)  xrnames(`slist')  aggr(`taggregate') pcexp(`1')   wappr(`meas') model(`model') subs(`subs')  gvimp(0) matpel(`matpel') matiel(`matiel') sotm(`sotm') ;
tempname  mat`tjob`i'' ;
matrix `mat`tjob`i'''= e(est);
...
prjob`tjob`i'' `vlist',   hs(`hsize') hgroup(`hgroup') lan(en)  xrnames(`slist')  aggr(`taggregate') pcexp(`1')   wappr(`meas') model(`model') subs(`subs')  gvimp(`gvimp')  pline(`pline') matpel(`matpel') matiel(`matiel') sotm(`sotm');
tempname  mat`tjob`i'' ;
matrix   `mat`tjob`i'''= e(est);
...
qui prjob`tjob`i'' `vlist',   hs(`hsize') hgroup(`hgroup') lan(en)  xrnames(`slist')  aggr(`taggregate') pcexp(`1')   wappr(`meas') model(`model') subs(`subs')  gvimp(`gvimp') matpel(`matpel') matiel(`matiel') sotm(`sotm');
...
qui prjob`tjob`i'' `vlist',   hs(`hsize') hgroup(`hgroup') lan(en)  xrnames(`slist')  aggr(`taggregate') pcexp(`1')   wappr(`meas') model(`model') subs(`subs')  gvimp(`gvimp')   epsilon(`epsilon') matpel(`matpel') matiel(`matiel') sotm(`sotm') ;
...
qui prjob`tjob`i'' `vlist',   hs(`hsize') hgroup(`hgroup') lan(en)  xrnames(`slist')  aggr(`taggregate') pcexp(`1')   wappr(`meas') model(`model') subs(`subs')  gvimp(`gvimp') theta(`theta') matpel(`matpel') matiel(`matiel') sotm(`sotm');
