...
gen poor_union = (w_1<14) | (w_2<14) | (w_3<14)
mean  poor_union 
imdp_uhi w_1 w_2 w_3, pl1(7) pl2(7) pl3(7)
// Q2
gen poor_inter = (w_1<14) & (w_2<14) & (w_3<14)
mean  poor_inter
imdp_ihi w_1 w_2 w_3, pl1(7) pl2(7) pl3(7)

// Q3 
/* 
The intersection headcount index is more sensitive, since we count only those with full multiple deprivations.
*/
...
gen poor_union_targ1 = (w_1+4<14) | (w_2<14)   | (w_3<14)
gen poor_union_targ2 = (w_1<14)   | (w_2+4<14) | (w_3<14)
gen poor_union_targ3 = (w_1<14)   | (w_2<14)   | (w_3+4<14)

gen poor_inter_targ1 = (w_1+4<14) & (w_2<14)   & (w_3<14)
gen poor_inter_targ2 = (w_1<14)   & (w_2+4<14) & (w_3<14)
gen poor_inter_targ3 = (w_1<14)   & (w_2<14)   & (w_3+4<14)

mean  poor_union* 
mean  poor_inter* 

/* With the union approach, we focus on less deprived individuals  (the case of individual number 6, the is only deprived in dimension 3) */
/* With the intersection approach, we focus on most deprived individuals (the case of individual number 3, and we target the dimension 2) */
...
cap drop ngap*
gen ngap1 = (14-w_1)/14*(14>w_1)
gen ngap2 = (14-w_2)/14*(14>w_2)
gen ngap3 = (14-w_3)/14*(14>w_3)
...
// Q2
imdp_bci w_1 w_2 w_3, alpha(1) gamma(1) b1(0.3333333) pl1(14) b2(0.3333333) pl2(14) b3(0.3333333) pl3(14)

// Q3
 gen nw_1 = (w_1+ w_2+w_3)/3
 gen nw_2 = (w_1+ w_2+w_3)/3
 gen nw_3 = (w_1+ w_2+w_3)/3
 imdp_bci nw_1 nw_2 nw_3, alpha(1) gamma(1) b1(0.3333333) pl1(14) b2(0.3333333) pl2(14) b3(0.3333333) pl3(14)
 /*
...
are the usual public services (education, heelth, etc), and where some households are deprived from these services.
*/

// Q6

cap drop tngap*
gen tngap1 = (7-(w_1+4))/7*(7>(w_1+4))
gen tngap2 = (7-(w_2+4))/7*(7>(w_2+4))
gen tngap3 = (7-(w_3+4))/7*(7>(w_3+4))
...
// Q1
use "C:\Users\abara\Desktop\exercises_10&11_\Canada_Incomes&Taxes_1996_2005_random_sample_3.dta", replace
...
The highest progressivity in Taxes in 2005 was in Alberta.
*/
