...
#delim ;
cap program drop ipolar2;  
program define ipolar2, rclass ;    
version 9.2;         
...
capture program drop ipolar;
program define ipolar, eclass;
version 9.2;
...
ipolar2 ``k'' , hweight(`hweight') hsize(`_ths') fast(`fast') alpha(`alpha')   conf(`conf') level(`level') dname("``k''");
...
ipolar2 `1' ,  hweight(`hweight')   hsize(`_ths')  fast(`fast') alpha(`alpha')  conf(`conf')   dname("`label`k''")
...
ipolar2 `1' ,   hweight(`hweight') hsize(`_ths') fast(`fast') alpha(`alpha')    conf(`conf') level(`level') dname("`1'");
...
local 1kk = $indica;
local index = "Duclos Esteban and Ray Index of Polarisation (2004)";
