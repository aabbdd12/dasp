...
{p_end}
 {p} where  {p_end}
{p 8 8} {cmd:varlist (min=3 max=3)} The household' purchased quantity of the item of interest, the household' price -or unit value- and the household disposible income (or total expenditures).{p_end}
{title:Description}
