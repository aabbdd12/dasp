...
tempname table;
   ...
   .`table'.sep,bot;
 disp in white " Notes :    ";
disp in white " _case A: Before this intersection, distribution 2 dominates distribution 1.";
disp in white " _case B: Before this intersection, distribution 1 dominates distribution 2.";
...
disp in white "Notes : No intersection founded.   ";
     if ("`_case'"=="A") disp in white "Distribution 1 dominates distribution 2.";
else if ("`_case'"=="B") disp in white "Distribution 2 dominates distribution 1.";
