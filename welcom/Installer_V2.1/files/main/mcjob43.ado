...
#delimit;
capture program drop mcjob43;
program define mcjob43, eclass;
version 9.2;
...
mcjobstat `tot_imp',   hs(`hsize') hgroup(`hgroup') lan(`lan')   xrnames(total)   stat(share_tot_exp) pcexp(`pcexp'); 
tempname mat43tot ;
...
mcjobstat `flist',   hs(`hsize') hgroup(`hgroup') lan(`lan')  xrnames(`slist')    stat(share_tot_exp) pcexp(`pcexp'); 
cap drop `drlist';
tempname mat43 ;
matrix `mat43'= e(est);
