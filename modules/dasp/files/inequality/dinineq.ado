...
/*****************************************************/
cap program drop dinineq_den;                    
program define dinineq_den, rclass;              
args fw x xval;                         
...
/* Quantile  & GLorenz                 */
/***************************************/
cap program drop dinineq_qua;
program define dinineq_qua, rclass sortpreserve;
...
cap program drop dinineq2;  
program define dinineq2, rclass ;    
version 9.2;         
...
capture program drop dinineq;
program define dinineq, eclass;
version 9.2;
...
dinineq2 `1' , hweight(`hweight1') hsize(`ths1')  p1(`p1') p2(`p2') p3(`p3') p4(`p4') index(`index') conf(`conf') level(`level') vab(`vab');
...
dinineq2 `2' , hweight(`hweight2') hsize(`ths2') p1(`p1') p2(`p2') p3(`p3') p4(`p4') index(`index')  conf(`conf') level(`level') vab(`vab') ;
if (`vab'==1) {;
tempvar vc vd;
qui gen `vc'=__va;
qui gen `vd'=__vb;
