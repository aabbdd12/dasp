...
capture program drop prjobatkinson;
program define prjobatkinson, eclass;
version 9.2;
...
local cnam `"`cnam' "The Atkinson index""';
local cnam `"`cnam' "Variation in the Atkinson index""';
local cnam `"`cnam' "Standard error""';
local cnam `"`cnam' "P_Value""';
