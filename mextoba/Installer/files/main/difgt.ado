...
program define difgt, /*eclass*/ rclass;
version 9.2;
syntax  namelist(min=2 max=2) [, FILE1(string) FILE2(string) HSize1(string) HSize2(string)
ALpha(real 0)  COND1(string) COND2(string) 
PLINE1(real 10000) OPL1(string) PROP1(real 50) PERC1(real 0.4)
PLINE2(real 10000) OPL2(string) PROP2(real 50) PERC2(real 0.4)
...
return scalar est1  = `r(est1)' ;
return scalar est2  = `r(est2)' ;
return scalar dif  = `r(est3)' ;
