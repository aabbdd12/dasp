...
help for {hi:itargetg }{right:Dialog box:  {bf:{dialog itargetg}}}
{hline}

{title:Poverty and targeting by population groups}

{p 8 12}{cmd:itargetg}  {it:varlist}{cmd:,} [  
...
{title:Description}
 ...
 {p}{cmd:itargetg} produces the following estimates and curves for a given list of population groups:{p_end}
 
{p 4 8}{inp:. Impact of targeting population groups on FGT indices}{p_end}
{p 4 8}{inp:. Impact of targeting population groups on FGT curves (along an axis of poverty lines)}{p_end}
{p 4 8}{inp:. The confidence interval of the impact of targeting population groups on FGT curves (along an axis of poverty lines)}{p_end}
...
itargetg income, alpha(0) pline(12000) hsize(hhsize) hgroup(sector) constam(1) cnor(yes)
itargetg income, hsize(hhsize)  hgroup(sector) alpha(0) type(prop) min(0) max(30000)
