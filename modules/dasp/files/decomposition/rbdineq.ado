...
if `dregres' == 1     xi: regress _log_dep `varlist' [aw=`fw'], `noconstant';
if `dregres' == 0 qui xi: regress _log_dep `varlist' [aw=`fw'], `noconstant';
};

if ("`model'"=="linear") {;
if `dregres' == 1     xi: regress `dep' `varlist' [aw=`fw'], `noconstant'; 
if `dregres' == 0 qui xi: regress `dep' `varlist' [aw=`fw'], `noconstant';
};
