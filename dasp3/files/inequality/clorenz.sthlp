...
{cmd:EGRA(}{it:string}{cmd:)} {p_end}
{syntab :  twoway_options: Y-Axis, X-Axis, Title, Caption, Legend, Overall ]}

{synopt :{it:{help twoway_options}}} any of the options documented in {bind:{bf:[G]} {it:twoway_options}}


{p 0 4} where {cmd:varlist} is a list of variables. {p_end}

{title:Version} 15.0 and higher.
{title:Description}
 
{p 0 4}{cmd:clorenz} produces the following curves for a given list of variables:{p_end}
