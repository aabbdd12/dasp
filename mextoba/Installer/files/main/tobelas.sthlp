...
{cmd:ELASFILE(}{it:string}{cmd:)} 
 ...
 {p_end}
 {p} where  {p_end}
{p 8 8} {cmd:varlist (min=2 max=2)} The household' purchased quantity of cigarettes and the household' price -or unit value- .{p_end}
{title:Description}
{p} The {cmd:tobelas} module is conceived to estimate the tobacco price elasticity by deciles.  
{p_end}
...
{p 0 4} {cmdab:indcont}     The list of the independent variables that are continues.  {p_end}  
