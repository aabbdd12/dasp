/*************************************************************************/
/* mcwel: Market Concentration and Welfare  (Version 2.00)               */
/*************************************************************************/
...
if ("`lan'" == "") local lan = "en";
if ("`tjobs'" == ""  & "`tjobs'"~="off")  local tjobs 12  21 22 23   31 32  41  42 43  51 52 53   61 62 63  64   ;
...
mk_xtab_ms mymat ,     matn(`matn')  dec(4) xfil(`xfil') xshe(table_11) xtit(`tabtit') xlan(`lan')  options(showeq) dste(0);
...
mcwel pc_ing_cor, hsize(tot_integ) pline(pline) gvimp(1) inisave(C:\PDATA\miwel2\test1) nitems(2) 
