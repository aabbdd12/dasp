...
ifgt  ae_exp, alpha(1) hsize(hsize) pline( 22828.025)
...
//  Q3:
ifgt ae_exp, hgroup(region) hsize(hsize) alpha(0) pline(20900)


//  Q3:
gen     ae_exp2=ae_exp
replace ae_exp2=ae_exp2*(1+0.11) if region==3
replace ae_exp2=ae_exp2*(1-0.06) if region==2


//  Q4:
dfgtgr ae_exp ae_exp2, alpha(1) pline(20900) hsize1(hsize) hsize2(hsize)

//  Q5:
dfgtg2d ae_exp ae_exp2, alpha(1) hgroup(region) pline(20900) hsize1(hsize) hsize2(hsize) ref(0)
