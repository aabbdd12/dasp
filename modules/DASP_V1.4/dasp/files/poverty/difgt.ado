...
if ("`type'"=="nor" & `al'!=0)  local equa1 = "(_b[`num1']/_b[`hs1']+_b[`snum1']/_b[`hs1'])/((_b[`hsy1']/_b[`hs1'])^`al')";
...
if ("`type'"=="nor" & `al'!=0)  local equa2 = "(_b[`num2']/_b[`hs2']+_b[`snum2']/_b[`hs2'] )/((_b[`hsy2']/_b[`hs2'])^`al')";
...
PLINE1(real 0) OPL1(string) PROP1(real 50) PERC1(real 0.4)
PLINE2(real 0) OPL2(string) PROP2(real 50) PERC2(real 0.4)
...
matrix _res_d1  =(`r(est)',`r(std)',`r(lb)',`r(ub)' ,`r(pl)');
...
matrix _res_d2 =(`r(est)',`r(std)',`r(lb)',`r(ub)' ,`r(pl)');
...
if ("`type'"=="not") local not = "Not normalised ";
	...
	local nalt = "ddd";
      ...
      .`table'.row "Distribution_1" el(_res_d1,1,1)  el(_res_d1,1,2) `lb_d1'  `ub_d1'  el(_res_d1,1,5); 
      .`table'.row "Distribution_2" el(_res_d2,1,1)  el(_res_d2,1,2) `lb_d2'  `ub_d2'  el(_res_d2,1,5);


  .`table'.sep,mid;
  .`table'.numcolor white white   white  white white white;
