...
local STD_C1_t2 = (`r(vara2)'+`var_mt2_pt1')^0.5;
...
local STD_C1_t1 = (`r(vara2)'+`var_mt1_pt2')^0.5;

local dif=`est_mt1_pt2'-el(_res_d1,1,1);
local lb   = `dif' -  `zzz'*`STD_C1_t1';
local ub   = `dif' +  `zzz'*`STD_C1_t1';
matrix _res_redt1 = (`dif',`STD_C1_t1',`lb',`ub');
matrix _res_rest1 = (el(_res_di,1,1)-el(_res_grt1,1,1)-el(_res_redt1,1,1),0,0,0);


local dif=el(_res_d2,1,1)-`est_mt2_pt1';
local lb   = `dif' -  `zzz'*`STD_C1_t2';
local ub   = `dif' +  `zzz'*`STD_C1_t2';
matrix _res_redt2 = (`dif',`STD_C1_t2',`lb',`ub');
