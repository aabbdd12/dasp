...
if (`alpha'==0 & "`xlan'"=="fr") local index = "Taux de pauvreté";
...
if (`alpha'==2 & "`xlan'"=="fr") local index = "Sévérité de la pauvreté";
...
if ("`xlan'"=="fr")  local xtit = "Tableau ##: Décomposition de la pauvreté selon...";
