...
Make sure that you have c:/dasp/dasp_p1.pkg, c:/dasp/dasp_p2.pkg  and c:/dasp/stata.toc;
...
copy the file profile.co in the directory c:/ado/personal (create a new folder "personal" if this does not exist); 
