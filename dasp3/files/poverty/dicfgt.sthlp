...
help for {hi:dicfgt }{right:Dialog box:  {bf:{dialog dicfgt}}}
{hline}

{title: Differences between FGT poverty curves with confidence interval} 

{p 8 10}{cmd:dicfgt}  {it:varlist}  {cmd:,} [ 
...
{title:Description}
 {p}{cmd:dicfgt}: To estimate: {p_end}
...
dicfgt exppc exppc, hsize1(size) cond1(sex==1) hsize2(size) cond2(sex==2)  alpha(0) min(0) max(1000000)
