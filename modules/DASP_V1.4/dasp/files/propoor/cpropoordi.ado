...
gen _perc=0; gen _est=0; gen _lb=0; gen _ub=0; 
...
qui mkmat _perc _est _lb _ub  in 1/101, matrix(RES);
};
...
qui gen _perc=0; qui gen _est=0; qui gen _lb=0; qui gen _ub=0; 
