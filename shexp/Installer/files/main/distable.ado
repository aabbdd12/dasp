...
version 9.2;
syntax namelist(min=1 max=1) [, MATRIX(string) DEC(int 3) DEC1(string) DEC2(string) DEC3(string) DEC4(string) DEC5(string) DEC6(string) FCLEN(int 16) CLEN(int 16) ATIT(string) HEAD1(string) HEAD2(string) dsmidl(int 0) LONGLAB(string) ];
tempname table;
tokenize `namelist';	
local ncol = colsof(`1');
...
if (`i'==`nrow' & `dsmidl' != -1) .`table'.sep, mid;
`line6'; 
};
.`table'.sep,bot;
 end;
