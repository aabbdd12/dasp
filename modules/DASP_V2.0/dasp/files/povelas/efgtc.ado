...
version 9.0;
syntax varlist(min=1)[, TOT(varname) HSize(varname)  HGroup(varname) ALpha(real 0) PLine(real 0) prc(real 1) type(string) dist(string) INDex(string) STD(string) dec(int 6) CI(real 5)  APPR(string)];
