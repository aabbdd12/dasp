...
tempvar   det1`k' det2`k' det3`k' det4`k';
qui gen `det1`k''=0;
qui gen `det2`k''=0;
qui gen `det3`k''=0;
qui gen `det4`k''=0;

tempvar   sdet1`k' sdet2`k' sdet3`k' sdet4`k' ;
qui gen `sdet1`k''=0;
qui gen `sdet2`k''=0;
qui gen `sdet3`k''=0;
qui gen `sdet4`k''=0;
...
forvalues i=4/6 {;
local j = `i'-3;
qui replace `det2`k'' = `r(est`i')'  in `j';
qui replace `sdet2`k'' = `r(ste`i')' in `j';

local z=`i'+4;
qui replace `det1`k'' = `r(est`z')'  in `j';
qui replace `sdet1`k'' = `r(ste`z')' in `j';
};

if `detail'==1 {;
forvalues i=1/3 {;
local j = 11 + 2*`i' ;
qui replace `det3`k''  =   `r(est`j')'  in `i'; 
qui replace `sdet3`k''  =  `r(ste`j')'   in `i'; 
local j = 11 + 2*`i' +1;
qui replace `det4`k''  =   `r(est`j')'  in `i'; 
qui replace `sdet4`k''  =  `r(ste`j')'   in `i'; 
};
};
...
if (`detail'==1) {;
	...
	local nalt = "ddd";
							   	...
							   	forvalues k=1/3 {; 
						                           .`table'.row `Dimedet'[`k'] `det1`g''[`k'] `det2`g''[`k']  `det3`g''[`k'] `det4`g''[`k'] ; 
								 if `dste' == 1    .`table'.row " " `sdet1`g''[`k'] `sdet2`g''[`k']  `sdet3`g''[`k'] `sdet4`g''[`k'] ; 
						       };
		.`table'.sep, bottom;					   
       };
