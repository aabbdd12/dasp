...
#delimit ;
capture program drop mk_xls_m1;
program define mk_xls_m1, rclass;
version 15.0;
...
mata: b.set_fill_pattern((pos,pos), (1,7), "solid", "`myfc3'" , "`myfc3'") 
mata: pos=pos+1
...
local m2  = el(_ms_pop,`v',3)
local s2  = el(_ms_pop,`v',4)
local dif  = el(_ms_pop,`v',5)
local sdif  = el(_ms_pop,`v',6)
local tval = `m1'/`s1'
local pval = tprob(`df1',`tval')
local ub = `m1'-invttail(`df1',`lvl')*`s1'
local lb = `m1'+invttail(`df1',`lvl')*`s1'
...
mata: b.set_font((`pos',`pos'),(2,7), "Cambria", 10 , "black") 
mata: b.set_font((`tnrows',`tnrows'),(2,7), "Cambria", 11 , "black") 
mata: r =(2,`tnrows')
mata: c =(2,`fp')
mata: b.set_font(r,c, "Cambria", 10 , "black")
if `gro' == 1 {
...
mata: b.set_font_bold((`tnrows',`tnrows'),(2,7), "on")
