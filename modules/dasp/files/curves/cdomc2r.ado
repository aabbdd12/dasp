...
capture program drop cdomc2rc2;
program define cdomc2rc2, rclass;
version 9.2;
...
capture program drop gcdomc2rc2;
program define gcdomc2rc2, rclass;
version 9.2;
...
capture program drop cdomc2r;
program define cdomc2r, rclass;
version 9.2;
...
local tits="s";
gen `fw'=1;
local tit1="Ratio Between Consumption Dominance"; 
local tit2="Ratio"; 
local tit3="";
local tit4="";
...
local ftitle = "Ratio Between Consumption Dominance Curve`tits'";
                   local ytitle = "Ratio";
...
gcdomc2rc2 `inc', hweight(`hweight') 
