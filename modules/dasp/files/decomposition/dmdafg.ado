...
if ("`xlan'"=="fr")  local xtit2 = "Tableau ##: Décomposition de l'indice AF-M0 par groupes";
if ("`xtit'"~="")    local xtit2 = "`xtit2'";

                     local xtit3 = "Table   ##: Decomposition of AF-M1 index by groups";
if ("`xlan'"=="fr")  local xtit3 = "Tableau ##: Décomposition de l'indice AF-M1 par groupes";
if ("`xtit'"~="")    local xtit3 = "`xtit3'";

                     local xtit4 = "Table   ##: Decomposition of AF-M2 index by groups";
if ("`xlan'"=="fr")  local xtit4 = "Tableau ##: Décomposition de l'indice AF-M2 par groupes";
