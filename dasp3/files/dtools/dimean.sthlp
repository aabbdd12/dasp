...
help for {hi:dimean }{right:Dialog box:  {bf:{dialog dimean}}}
{hline}

{title: Difference between means} 
{p 8 10}{cmd:dimean}  {it:varlist}  {cmd:,} [ 
...
{p 8 8} {cmd:varlist} is a list of two variables (the variables of interest for the first and the second distributions).  {p_end}

{title:Version} 15.0 and higher.

{title:Description}
 {p}{cmd:dimean}: To estimate: {p_end}
 
{p 4 8}{inp:. The means for the two distributions as well as their difference.}{p_end}
{p 4 8}{inp:. Standard errors of these statistics taking full account of survey design}{p_end}
...
dimean exppc exppcz, file1(file_1994.dta) hsize1(size) file2(file_1998.dta) hsize2(size) dec(5) test(0)
