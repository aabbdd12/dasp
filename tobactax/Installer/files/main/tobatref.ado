/************************************************************************************/
/* tobatref: Tobacco Tax Reform and Welfare  (Version 1.00)                           */
/************************************************************************************/
...
#delim ;
set more off;
capture program drop tobatref;
program define tobatref , eclass sortpreserve;
version 9.2;
...
local  myrownames Decile_1 Decile_2 Decile_3 Decile_4 Decile_5  Decile_6  Decile_7  Decile_8  Decile_9 Decile_10 Population ;
matrix rownames  `mat20' = `myrownames'  ;
dismat_mod21 `mat20', dec1(0) dec2(0) dec3(2) dec4(0) dec5(2) dec6(2)   atit(`langr') head1(`tabtit')  head2(`head2') ;
...
if "`max`gjob`i'''"=="" local max`gjob`i'' = 10;
cmnpe `gmat1',  min(`min`gjob`i''') max(`max`gjob`i''') 
...
if "`min`gjob`i'''"=="" local min`gjob`i'' = 1;
if "`max`gjob`i'''"=="" local max`gjob`i'' = 10;
cmnpe `gmat2',  min(`min`gjob`i''') max(`max`gjob`i''')  band(1.0) 
...
if "`min`gjob`i'''"=="" local min`gjob`i'' = 1;
if "`max`gjob`i'''"=="" local max`gjob`i'' = 10;
cmnpe `gmat3',  min(`min`gjob`i''') max(`max`gjob`i''') band(1.0) 
...
if "`min`gjob`i'''"=="" local min`gjob`i'' = 1;
if "`max`gjob`i'''"=="" local max`gjob`i'' = 10;
cmnpe `gmat4',  min(`min`gjob`i''') max(`max`gjob`i''') band(1.0) 
