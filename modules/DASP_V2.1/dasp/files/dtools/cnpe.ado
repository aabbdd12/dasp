...
local label`f'  =  "``k''";
if ("`type'"=="npr") {;
cnpe2 `fw' `xvar' ``k'' `min' `max'  `rtype' `band'  `approach' `vgen' ;
qui svmat float _xx;
cap matrix drop _xx;
rename _xx1 _cory`k';
...
if ("`type'"=="dnp") {;
 npde2 `fw' `xvar' ``k'' `min' `max'  `rtype' `band' `approach' `vgen';
qui svmat float _xx;
cap matrix drop _xx;
rename _xx1 _cory`k';
...
if ("`type'"=="npr") {;
cnpe2 `fw' `xvar'  `1' `min' `max'  `rtype' `band' `approach' `vgen'  `hgroup' `k';
qui svmat float _xx;
cap matrix drop _xx;
rename _xx1 _cory`k';
...
if ("`type'"=="dnp") {;
npde2 `fw' `xvar'  `1' `min' `max'  `rtype' `band' `approach' `vgen'  `hgroup' `k';
qui svmat float _xx;
cap matrix drop _xx;
rename _xx1 _cory`k';
