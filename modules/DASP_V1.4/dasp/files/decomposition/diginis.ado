...
if ("`appr'" == "lay" & "`xlan'"=="fr")   {;
local cnam `"`cnam' "Corrélation de Gini""';
...
if ("`xlan'"=="fr")  local xtit = "Tableau ##: Décomposition de l'indice de Gini selon les composantes du revenu";
...
if ("`appr'" == "rao" & "`xlan'"=="fr") local note2 = "[-] Décomposition selon l'approche de Rao (1969).";
if ("`appr'" == "lay" & "`xlan'"=="fr") local note2 = "[-] Décomposition selon l'approche de Lerman and Yitzhaki (1985).";
if ("`appr'" == "ara" & "`xlan'"=="fr") local note2 = "[-] Décomposition selon l'approche de Araar (2006).";
