...
version 9.0;
syntax varlist(min=1 max=1)[, HSize(varname)  HGroup(varname) RHO(real 2) ALpha(real 0) PLine(real 0) prc(real 1) type(string) dist(string) INDex(string) STE(string) dec(int 6) CI(real 5)];
local type="nor";
if ("`hgroup'"!="") {;
preserve;
