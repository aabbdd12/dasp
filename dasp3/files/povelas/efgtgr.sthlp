...
help for {hi:efgtgr }{right:Dialog box:  {bf:{dialog efgtgr}}}
{hline}

{title:Description}
{p 8 8} 
The module {cmd:efgtgr} estimates FGT elasticities with respect to average income growth.
...
efgtgr income, hgroup(sector) hsize(hhsize) alpha(1) pline(10000)
