...
dipolder2 `1' , hweight(`hweight1') hsize(`ths1') alpha(`alpha') fast(`fast') conf(`conf') level(`level') vab(`vab') dname("Distribution 1");
...
dipolder2 `2' , hweight(`hweight2') hsize(`ths2') alpha(`alpha') fast(`fast') conf(`conf') level(`level') vab(`vab') dname("Distribution 2");
if (`vab'==1) {;
tempvar vd ve vf;
qui gen `vd'=__va;
qui gen `ve'=__vb;
