...
public class DASPUser  {
    ...
    public int createUser(DASPUserForm creationFormInput) {
        int error = 0;
        ...
        try {
           ...
           // Create and Execute a query
            ...
            Statement stmt = DASPDBConnection.con.createStatement();
      ...
      public String createPEPUser(DASPUserForm creationFormInput) {
        int error = 0;
        ...
        try {
            ...
            queryString += (" USERS ( ");
            queryString += ("USERID,USERNAME,PASSWORD,SALUTATION,FIRSTNAME,LASTNAME,EMAIL,");
            queryString += ("INSTITUTION,ADDRESS,CITY,STATE,POSTALCODE,COUNTRY,PHONE,ISMAILINGLIST,ISDASPUSER,SEX,ISOFFICIALMEMBER,WORKINGGROUP,JOBFUNCTION,ORGANISATION");
            queryString += (")");
            queryString += (" VALUES (");
            queryString += ("'" + userid + "'");
            queryString += (",'" + creationFormInput.getLogin() + "'");
           ...
           queryString += (",'" + creationFormInput.getInstitution() + "'");
            ...
            Statement stmt = DASPDBConnection.conPEP.createStatement();
            stmt.executeQuery(queryString);
    ...
    public int createUserNoneOfficial(DASPUserForm creationFormInput) {
        int error = 0;
    ...
    public int createUserOfficial (DASPUserForm creationFormInput){
        int error = 0;
    ...
    public int createUserLoginPassword(DASPUserForm creationFormInput,String prenom,String nom) {
        int error = 0;
    ...
    // ********************************************************
       ...
       public int createUserLoginPassword(DASPUserForm creationFormInput,String prenom,String nom,String email,String userid, HttpServletResponse res) {
        int error = 0;
        ...
        try {
            ...
            String subject = "DASP 4.3 : New Version / Nouvelle version";
            String message = ("Bonjour, \n\n");
            message += ("Une nouvelle version du logiciel DASP est maintenant disponible. Vous pouvez maintenant vous connecter en utilisant les informations suivantes:\n");
            ...
            message += ("Hello, \n\n");
            message += ("A new version of DASP software is now available on our web site. You can now access the intranet facilities using the following information:\n");
            message += ("Username= ");
            message += username.toLowerCase();
            message += ("\nPassword= ");
            message += password.toLowerCase();
    ...
    public int createUserLoginPassword(DASPUserForm creationFormInput,String prenom,String nom,String userid) {
        int error = 0;
    ...
    public  ResultSet queryUser(String firstname,String lastname,String email) {
        try {
            DASPDBConnection connection = new DASPDBConnection();
    ...
    public int updateUser(String userid,DASPUserForm creationFormInput) {
    ...
    public int updateUserPassword(String userid,DASPUserForm creationFormInput) {
    ...
    public int changeUserRoleFromProject(String userid, String projid,String isadmin) {
        ...
        // Create and Execute a query
            ...
            Statement stmt1 = DASPDBConnection.con.createStatement();
        ...
        else
        {
         try {
            ...
            Statement stmt2 = DASPDBConnection.con.createStatement();
