 ...
 * @version
 */
public class DASPDBConnection  {

    static Connection con = null;
    static Connection conPEP = null;
   private ResultSet rs = null;

    public DASPDBConnection()
    {
    }
    ...
    public void ConnectDB() {
        ...
        try {
            System.out.println("Triing to connect database ... DASP ");
            Class.forName("org.gjt.mm.mysql.Driver2");
        }
        ...
        try {
            ...
            con = DriverManager.getConnection("jdbc:mysql://132.203.59.36/DASP?user=admins&password=cirpep");
      ...
      public Connection ConnectDBPEP() {
        ...
        try {
            ...
            conPEP = DriverManager.getConnection("jdbc:mysql://132.203.59.36/DASP?user=admins&password=cirpep");
            return conPEP;
     ...
     public Connection ConnectDB2() {
        ...
        try {
            ...
            con = DriverManager.getConnection("jdbc:mysql://localhost/DASP?user=admins&password=cirpep");
