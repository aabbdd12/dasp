...
{p 0 4} {cmdab:cnor}    To normalise the CD curve by the average cost, selected the option "yes". {p_end}

{p 0 4} {cmdab:fnor}    To normalise the FGT index by the poverty line, selected the option "yes". {p_end}
...
cdomc hcons1 hcons3, inc(pci) prc(1) order(1) pline(12000)
cdomc hcons1 hcons3, inc(pci) prc(1) order(2) min(1000) max(30000) cnor(yes) dci(yes) level(95)
