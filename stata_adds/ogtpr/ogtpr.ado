...
#delimit cr
use "C:\data\bkf98I.dta", clear
ogtpr exppc, hgroup(gse) hsize(size) alpha(0) pline(80000) trans(4000) ered(1) part(1000)

/*
/*
recode gse (4=1)(1=2) (7=3) , generate(ngse)
...
crossgroup gse strata
*set trace on*/
cap drop part red1 red2
gen part = 0
gen red1=0
gen red2=0
ogtpr exppc, hgroup(gse) hsize(size) alpha(0) pline(80000) trans(4000) ered(1) part(100)
qui replace part=100    in 1
qui replace red1= r(r1) in 1
ogtpr exppc, hgroup(gse) hsize(size) alpha(0) pline(80000) trans(4000) ered(1) part(500)
qui replace part=500    in 2
qui replace red1= r(r1) in 2
ogtpr exppc, hgroup(gse) hsize(size) alpha(0) pline(80000) trans(4000) ered(1) part(1000)
qui replace part=1000    in 3
qui replace red1= r(r1)  in 3
ogtpr exppc, hgroup(gse) hsize(size) alpha(0) pline(80000) trans(4000) ered(1) part(2000)
qui replace part=2000    in 4
qui replace red1= r(r1)  in 4


line red1 part in 1/4, xtitle(Number of partitions) ytitle(The reduction in the headcount)
