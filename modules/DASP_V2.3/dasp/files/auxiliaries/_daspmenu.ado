...
window menu append item "&Multidimensional poverty" /* 
*/ "Bourguignon and Chakravarty (2003) MD index"   "db imdp_bci"
...
window menu append item "Progressivity" /* 
        */   "Kakwani // Reynols & Smolensky indices"  "db iprog"
...
window menu append item "Distributive tools" "Non parametric regression curves with CI" "db cnpeci"
window menu append separator "Distributive tools"
