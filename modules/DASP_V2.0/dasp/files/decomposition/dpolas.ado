...
version 9.2;
syntax varlist(min=1)[, HSize(varname)  HGroup(varname)  APPR(string)  DEC(int 6) DSTD(int 1) ALpha(real 0.5) OPtion(int 1) FAst(int 0) ];
preserve;
local ll=0;
qui svyset ;
...
local ll=`ll'+10;
	...
	di _n as text "{col 4} Decomposition of the DER Index of Polarisation by Incomes Sources: Araar's (2008) Approach.";
