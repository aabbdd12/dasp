...
capture program drop mcjobgini;
program define mcjobgini, eclass;
version 9.2;
...
if ("`aehs'" ~= "" ) qui replace `asliving' = `sliving'*`_ths'/`aehs' ;
gen `osliving' = `asliving' ;
basicgini `pcexp' `asliving',  hsize(`_ths') ;
};
...
qui gen `asliving' = `sliving';
if ("`aehs'" ~= "" ) qui replace `asliving' = `sliving'*`_ths'/`aehs' ;
if (`move'== 1)   basicgini `asliving' `osliving',  hsize(`_ths');
if (`move'==-1)   basicgini `asliving' `pcexp' ,  hsize(`_ths') ;
...
qui gen `asliving' = `sliving';
if ("`aehs'" ~= "" ) qui replace `asliving' = `sliving'*`_ths'/`aehs' ;
basicgini `pcexp' `osliving',  hsize(`_ths') ;
};
