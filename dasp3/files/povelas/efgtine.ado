...
capture program drop efgtine;
program define efgtine, rclass;
version 9.2;
syntax varlist [,   
HSize(string) 
HGroup(varname)
...
efgtin2 ``k'' ,  hsize(`_ths') pl(`pline') al(`alpha') appr(`appr') est(`est') perc(`perc')  gnumber(-1) glabel("``k''") ;
...
efgtin2 `1' ,   hsize(`_ths') pl(`pline') al(`alpha')  hgroup(`hgroup') gnumber(`kk') appr(`appr') est(`est') perc(`perc') glabel(`grlab`k'');
qui replace `Estimate' = `r(est)'*`multi' in `k';
if "`appr'" == "all" {;
qui replace `Estimate1' = `r(est1)'*`multi' in `k';
qui replace `Estimate2' = `r(est2)'*`multi' in `k';
...
if ("`hgroup'"!="") {;
efgtin2 `1' ,   hsize(`_ths') pl(`pline') al(`alpha') appr(`appr') est(`est') perc(`perc') glabel("Population");
local kk =$indica + 1;
...
local ftitle = "Semi-Elasticity of poverty FGT with respect to Gini Inequality";
...
if ("`hgroup'"=="") {;
local label`f'  =  "``k''";
gefgtin2 ``k'' ,  hsize(`_ths') pl(`pline') al(`alpha') appr(`appr')  gnumber(-1) glabel("``k''")  min(`min') max(`max');
};
...
gefgtin2 `1' ,   hsize(`_ths') pl(`pline') al(`alpha')  hgroup(`hgroup') gnumber(`kk') appr(`appr')  glabel(`grlab`k'') min(`min') max(`max');
